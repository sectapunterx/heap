...
// branch anyone writes for it names the tracker key ("PROJ-123"). Unless the
// key is registered and resolved, such a branch matched nothing — or, with a
// single local prefix, matched a different task that shared the number.
