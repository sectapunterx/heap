...
// The lookup is called on essentially every mutation and from ~30 places in
// AppController; it is now a hash rebuilt lazily on structural change. These
// pin the cases where rows shift under it.
